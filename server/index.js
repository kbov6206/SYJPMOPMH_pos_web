const express = require('express');
   ...
   const { insertSalesData, insertDueBalanceData, getRecentSales, getRecentDueBalances, getNames, updateSalesData, updateDueBalanceData, getSalesData, getDueBalanceData, checkDuplicateBillNumber } = require('./bigquery.js');
   ...
   app.post('/api/due-balance', async (req, res) => {
     try {
       ...
       const result = await insertDueBalanceData(data, 'reachadeel@gmail.com');
