...
function App() {
  ...
  }, notification.message), isLoading && React.createElement('div', {
    className: 'loading-overlay'
  }, 'Authenticating...'), isAuthenticated ? React.createElement('div', null, React.createElement('div', {
    className: 'flex justify-between p-4 bg-gray-100'
  }, React.createElement('h1', {
    className: 'text-xl font-bold'
  }, 'SYJPMOPMH POS'), React.createElement('div', null, React.createElement('span', {
    className: 'mr-4'
  }, userEmail), React.createElement('button', {
    onClick: logout,
    className: 'bg-red-500 text-white p-2 rounded'
  }, 'Logout'))), React.createElement(SalesForm, {
    userEmail,
    showNotification
...
function SalesForm(_ref2) {
  ...
  const isCombinationAFilled = () => {
    return salesRows.some(isItemRowFilled) && isDueBalanceGroupFilled() && isBalanceDueGroupFilled() && salesPaymentRows.some(isPaymentRowFilled);
  };
  const isCombinationBFilled = () => {
    return salesRows.some(isItemRowFilled) && isBalanceDueGroupFilled() && salesPaymentRows.some(isPaymentRowFilled);
  };
  const isCombinationCFilled = () => {
    return isDueBalanceGroupFilled() && salesPaymentRows.some(isPaymentRowFilled);
  };
  const isCombinationDFilled = () => {
    return salesRows.some(isItemRowFilled) && isDueBalanceGroupFilled() && salesPaymentRows.some(isPaymentRowFilled);
  };
  ...
  const submit = async () => {
    ...
    try {
      const response = await fetch(window.API_URL, {
        ...
        body: JSON.stringify({
          action: isEditMode ? 'updateSalesData' : 'saveSalesData',
          data,
          userEmail
        })
      });
  ...
  return React.createElement('div', {
    id: 'sales',
    className: 'module max-w-4xl mx-auto p-4'
  }, React.createElement('h2', {
    className: 'text-2xl font-bold mb-4'
  }, 'Sales Data Entry'), isLoading && React.createElement('div', {
    className: 'loading-overlay'
  }, isEditMode ? 'Updating sales data...' : 'Saving sales data...'), React.createElement('div', {
    id: 'salesForm'
  }, React.createElement('div', {
    ...
    htmlFor: 'salesBillNumber',
    className: 'block mb-1'
  }, 'Bill Number'), React.createElement('input', {
    type: 'text',
    id: 'salesBillNumber',
    ...
    htmlFor: 'salesSalesman',
    className: 'block mb-1'
  }, 'Salesman'), React.createElement('select', {
    id: 'salesSalesman',
    ...
    value: ''
  }, 'Select'), salesmen.map(salesman => React.createElement('option', {
    key: salesman,
    value: salesman
  }, salesman)))), React.createElement('div', null, React.createElement('label', {
    htmlFor: 'salesShopName',
    className: 'block mb-1'
  }, 'Shop Name'), React.createElement('select', {
    id: 'salesShopName',
    ...
    value: ''
  }, 'Select'), shopNames.map(name => React.createElement('option', {
    key: name,
    value: name
  }, name))))), React.createElement('div', {
    className: 'static-row'
  }, React.createElement('div', null, React.createElement('label', {
    htmlFor: 'salesDepartment',
    className: 'block mb-1'
    ...
    value: ''
  }, 'Select'), departments.map(dept => React.createElement('option', {
    key: dept,
    value: dept
  }, dept)))), React.createElement('div', null, React.createElement('label', {
    htmlFor: 'salesPhoneNumber',
    className: 'block mb-1'
  ...
  }, 'RMD/CST'), React.createElement('span', null)), salesRows.map((row, index) => React.createElement('div', {
    key: index,
  ...
  }, `Row ${index + 1}`), React.createElement('select', {
    ...
    value: ''
  }, 'Select'), salesItems.map(item => React.createElement('option', {
    key: item,
    value: item
    ...
    value: ''
  }, 'Select'), rmdCstms.map(rmd => React.createElement('option', {
    key: rmd,
    value: rmd
  }, rmd))), React.createElement('button', {
    type: 'button',
    ...
    onClick: addRow
  }, 'Add Item Row'), React.createElement('div', {
    id: 'payment-row'
  }, React.createElement('div', {
    className: 'dynamic-row font-bold'
  }, React.createElement('span', {
  ...
  }, 'Paymode'), React.createElement('span', {
    style: {
      flex: 1,
      minWidth: '120px'
    }
  }, 'Amount Received'), React.createElement('span', null)), salesPaymentRows.map((row, index) => React.createElement('div', {
    key: index,
    className: 'dynamic-row'
  }, React.createElement('span', {
    style: {
  ...
  }, `Payment ${index + 1}`), React.createElement('select', {
    value: row.paymode,
    ...
    value: ''
  }, 'Select'), paymodes.map(paymode => React.createElement('option', {
    key: paymode,
    value: paymode
  }, paymode))), React.createElement('input', {
    type: 'number',
    step: 'any',
    ...
    className: 'block mb-1'
  }, 'Due Balance Received'), React.createElement('input', {
    type: 'number',
    step: 'any',
    ...
    value: ''
  }, 'Select'), billNumbers.map(bill => React.createElement('option', {
    key: bill.Bill_Number,
    value: bill.Bill_Number
  }, `${bill.Bill_Number} (${bill.Date && bill.Date.value ? new Date(bill.Date.value).toISOString().split('T')[0] : 'Unknown'})`))))), React.createElement('div', {
    className: 'static-row'
  }, React.createElement('div', null, React.createElement('label', {
    htmlFor: 'salesBalanceDue',
    className: 'block mb-1'
  }, 'Balance Due'), React.createElement('input', {
    type: 'number',
    step: 'any',
    id: 'salesBalanceDue',
    ...
    htmlFor: 'salesDeliveryDate',
    className: 'block mb-1'
  }, 'Delivery Date'), React.createElement('input', {
    type: 'text',
    ...
    id: 'salesTotalAmount',
    className: 'font-bold'
  }, `Total Amount: ${totalAmount.toFixed(2)}`), React.createElement('div', {
